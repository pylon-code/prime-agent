...
export const RECOVERABLE_OWNED_SESSION_ADOPTION_FEATURE = "recoverable_owned_session_adoption_v1" as const;
export const NONPERSISTENT_DAEMON_WORKER_FEATURE = "nonpersistent_daemon_worker_v1" as const;
