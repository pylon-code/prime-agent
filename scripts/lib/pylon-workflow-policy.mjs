...
export function verifyApprovedWorkflowAtSignerDigest(workflowPath, signerDigest, channel) {
	return validateApprovedAttestationWorkflow(readWorkflowAtSignerDigest(workflowPath, signerDigest), channel);
}
